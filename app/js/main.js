...
headerBtn?.addEventListener('click', () => {
  ...
  if (isActive) {
    ...
    headerBtn?.classList.remove('btn-close');
    document.body.classList.remove('scroll-lock');
  } else {
  ...
  if (typeof Swiper !== 'undefined' && document.querySelector('.lookperfect__slider')) {
    new Swiper('.lookperfect__slider', {
      loop: true,
      slidesPerView: 3,
      spaceBetween: 40,
      navigation: {
  ...
  if (typeof Swiper !== 'undefined' && document.querySelector('.rewiews__slider')) {
    new Swiper('.rewiews__slider', {
      ...
      breakpoints: {
        200: { slidesPerView: 2.5, spaceBetween: 10 },
        360: { slidesPerView: 4.5, spaceBetween: 10 },
        480: { slidesPerView: 6.5, spaceBetween: 10 },
      },
    });
  }
